...
public class RegistMemberActivity extends AppCompatActivity {
    ...
    public void clickOk(View v){
        rb=(RadioButton) RegistMemberActivity.this.findViewById(radiogroup.getCheckedRadioButtonId());
        ...
        if(name.equals("")||introduce.equals("")){
            ...
            SimpleMultiPartRequest smpr=new SimpleMultiPartRequest(Request.Method.GET, memberinsertUrl, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(RegistMemberActivity.this, "에러!!", Toast.LENGTH_SHORT).show();
                }
            });
