...
public class SelectedMatchingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selected_matching);
        ...
        SimpleMultiPartRequest smpr = new SimpleMultiPartRequest(Request.Method.POST, loadTeamImgURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Glide.with(SelectedMatchingActivity.this).load(imgurl).into(imageView);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SelectedMatchingActivity.this, "에러", Toast.LENGTH_SHORT).show();
            }
        });
